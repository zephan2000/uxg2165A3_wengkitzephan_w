...
//Zephan
public class session //ref class to store game data on run time
{
	...
	public session(string saveId, string seshname, string saveStatus, string actorName, string actorType, string levelId, int currenthp, int maxhp, int physicaldmg, int magicdmg, int vitality, int power,
